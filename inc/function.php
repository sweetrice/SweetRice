...
{
    return array(
        'category'     => array('title' => _t('Category'), 'file' => 'do_category.php', 'type' => 1, 'child' => array(
            array('title' => _t('List'), 'request' => array('type' => 'category')),
            array('title' => _t('Create'), 'request' => array('type' => 'category', 'mode' => 'insert')),
        ),
        ),
        'post'         => array('title' => _t('Post'), 'file' => 'do_post.php', 'type' => 1, 'child' => array(
        ...
        'setting'      => array('title' => _t('Setting'), 'type' => 2, 'child' => array(
        ...
        'cache'        => array('title' => _t('Cache'), 'file' => 'do_cache.php', 'type' => 1, 'child' => array(
            array('title' => _t('Expired'), 'request' => array('type' => 'cache'), 'ncr' => true),
            array('title' => _t('Full'), 'request' => array('type' => 'cache', 'mode' => 'full'), 'ncr' => true),
        ),
        ),
        'update'       => array('mustBase' => true, 'title' => _t('Update'), 'file' => 'do_update.php', 'type' => 1, 'child' => array(
            array('title' => _t('Check'), 'request' => array('type' => 'update')),
        ),
        ),
        'sites'        => array('title' => _t('Sites'), 'mustBase' => true, 'file' => 'do_sites.php', 'type' => 1, 'child' => array(
            array('title' => _t('List'), 'request' => array('type' => 'sites')),
            array('title' => _t('Create'), 'request' => array('type' => 'sites', 'mode' => 'insert')),
        ),
        ),
        'data'         => array('title' => _t('Data'), 'file' => 'do_data.php', 'type' => 1, 'child' => array(
