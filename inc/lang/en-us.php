 ...
 */
	...
	return array(
		...
		'inc is not writable' => 'inc is not writable',
		'root dir is not writable' => 'root dir is not writable',
		'attachment is not writable' => 'attachment is not writable',
		'as/lib is not writable' => 'as/lib is not writable',
...
SweetRice	
	...
	'%s You can Visit <a href="%s">%s</a> Home page <div id="div_foot">Powered by <a href="https://www.sweetrice.xyz">SweetRice.xyz</a> SweetRice.</div>' => '%s You can Visit <a href="%s">%s</a> Home page <div id="div_foot">Powered by <a href="https://www.sweetrice.xyz">SweetRice.xyz</a> SweetRice.</div>',
	...
	'Add File' => 'Add File',
	'<p>Input rule:please note that the source URL must without "http(s)://" and your domain.</p>example: <ol><li>enter <strong>source.html->destination.html</strong> to redirect http(s)://yourdomain.com/source.html to http(s)://yourdomain.com/destination.html</li><li>enter <strong>source.html->http(s)://otherdomain.com/destination.html</strong> to redirect http(s)://yourdomain.com/source.html to http(s)://otherdomain.com/destination.html</li><li>Support regular rule,example: <strong>/^page\/([a-z0-9]+)\.html$/i->action=entry&post=$1</strong> to parse the url and <strong>/^page\/([a-z0-9]+)\.html$/i->$1.html</strong> to redirect the url.</li></ol>' => '<p>Input rule:please note that the source URL must without "http(s)://" and your domain.</p>example: <ol><li>enter <strong>source.html->destination.html</strong> to redirect http(s)://yourdomain.com/source.html to http(s)://yourdomain.com/destination.html</li><li>enter <strong>source.html->http(s)://otherdomain.com/destination.html</strong> to redirect http(s)://yourdomain.com/source.html to http(s)://otherdomain.com/destination.html</li><li>Support regular rule,example: <strong>/^page\/([a-z0-9]+)\.html$/i->action=entry&post=$1</strong> to parse the url and <strong>/^page\/([a-z0-9]+)\.html$/i->$1.html</strong> to redirect the url.</li></ol>',
	'Keys' => 'Keys',
	'Vals' => 'Vals',
	'Please select table to converter,current database is' => 'Please select table to converter,current database is',
	'SQL Execute' => 'SQL Execute',
