...
<tr id="tr_<?php echo $no;?>">
	<td class="max50" data-label="<?php _e('Host');?>"><span class="sortNo" id="sortNo_<?php echo $no;?>"><?php echo $no;?></span><a href="http://<?php echo $key.substr(BASE_URL,strlen($_SERVER['HTTP_HOST'])+7);?>"><span id="domain_<?php echo $no;?>"><?php echo $key;?></span></a></td>
