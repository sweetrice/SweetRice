 ...
 */
 ...
 if($mode=='save'){
	...
	$setting = serialize(array('name'=>escape_string($_POST["name"]) , 'author'=>escape_string($_POST["author"]) ,'title'=>escape_string($_POST["title"]) , 'keywords'=>escape_string($_POST["keyword"]) , 'description'=>escape_string($_POST["description"]) ,  'admin'=>$_POST["admin"] , 
	'passwd'=>$passwd,
	'close'=>intval($_POST["close"]) ,
	'close_tip'=>$_POST["close_tip"],
	...
	setOption('global_setting',db_escape($setting));
