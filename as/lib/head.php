...
<?php form_token('', null, 'meta');?>
<meta id="form_token_expired" content="<?php echo ini_get('session.gc_maxlifetime'); ?>" />
<title><?php echo (isset($top_word) ? $top_word : _t('Welcome to SweetRice!')), ' - ', _t('Dashboard'); ?></title>
...
<div id="top_word">
<h1><?php echo isset($top_word) ? $top_word : _t('Welcome to SweetRice!'); ?></h1>
</div>
