...
<title><?php echo isset($title) ? $title : $global_setting['title']; ?></title>
<base href="<?php echo BASE_URL; ?>"/>
<meta name="keywords" content="<?php echo isset($keywords) ? $keywords : $global_setting['keywords']; ?>" />
<meta name="description" content="<?php echo isset($description) ? $description : $global_setting['description']; ?>"/>
