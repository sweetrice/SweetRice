...
<div id="content">
	<div id="nav"><a href="<?php echo BASE_URL;?>"><?php echo HOME;?></a> &raquo; <?php echo CATEGORY;?> <a href="<?php echo show_link_cat($categories[$cat_id]['link'],'');?>"><?php echo $categories[$cat_id]['name'];?></a> <?php echo PARENT;?> <a href="<?php echo $categories[$row_cat['parent_id']]?show_link_cat($categories[$row_cat['parent_id']]['link'],''):BASE_URL;?>"><?php echo $categories[$row_cat['parent_id']]?$categories[$row_cat['parent_id']]['name']:'Main';?></a></div>
	<div id="posts">
<?php
	if(count($rows)==0):
